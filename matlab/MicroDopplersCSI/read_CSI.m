function CTF = read_CSI()
    ...
    % and receive antenna, respectively. Each matrix corresponds to a CTF with dimensions Nf X Nt, where Nf % and Nt denote the number of frequency and time bins, respectively. Nf always has a value of 30,
    % whereas Nt is variant depending on the sampling rate dt and how many recording seconds.
